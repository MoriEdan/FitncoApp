...
export const Tabs = ({tab1, tab2, tab3, activePage}) => {
  ...
  return (
    <View style={styles.tabWr}>
      ...
      <TouchableOpacity
        onPress={tab3.onPress}
        style={{
          ...styles.tabItemWr,
          borderTopRightRadius: 20,
          borderBottomRightRadius: 20,
          backgroundColor: activePage == 2 ? COLORS.PRIMARY : COLORS.LIGHT_GRAY,
        }}>
        <Text style={styles.tabText}>{tab3.text}</Text>
      </TouchableOpacity>
    </View>
  );
};
